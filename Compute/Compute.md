...
- **Amazon ECS / EKS**: Container orchestration for microservices in Docker/Kubernetes.


AWS Lambda – fundamentals
What is AWS Lambda, and how does it differ from running Node.js on EC2 or containers in terms of scaling and operational responsibility?
​

Explain the concept of serverless architecture and where Lambda fits in a microservices‑based system.
​

What are common event sources for Lambda in a microservice backend (for example, API Gateway, S3, SQS, EventBridge, DynamoDB streams), and when would you use each?
​

Describe the Lambda execution role and how IAM permissions control what a function can access in other AWS services.
​

How do you configure and securely manage environment variables for a Lambda function in production?
​
